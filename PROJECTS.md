...
|:--|:--|:--|:--|
| **[tlk-tune](https://github.com/Talkdedsec/tlk-tune)** | Terminal music player for Windows. One executable, no ffmpeg, mouse and keyboard, album art, synced lyrics, ten-band EQ. | `Rust` `audio` `cli` | 16 Sept 2026 |
...
<sub>Synced 16 Sept 2026 · public repositories only</sub>
<!-- OSS:END -->
